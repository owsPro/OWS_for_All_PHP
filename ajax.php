...
*****************************************************************************/
	...
	$output['messages']=$e->getMessage();}}if(Request('contentonly'))echo$output['content'];else{$output['messages']=$viewHandler->renderBlock('messagesblock',json_decode($block['messagesblock'],TRUE));echo json_encode($output);}