...
//+ owsPro - There was an error in the match intervention. Twig needs from version 2.x mb_str_tolower that we go over with strtolower. You can no longer see the abbreviated first name dot surname, but rather the surname comma first name.
