...
*****************************************************************************/
					...
					'/cache/wsconfigadmin.inc.php',CurrentLanguage());include('/languages/messages_%s.php',CurrentLanguage());$errors=[];$inputEmail=(isset($_POST['inputEmail']))?trim($_POST['inputEmail']):FALSE;
