...
*****************************************************************************/
					...
					if($inputEmail){$now=Timestamp();if(count($errors)==0){$columns=array('id','passwort_neu_angefordert','name','passwort_salt');$fromTable=$conf['db_prefix'].'_admin';$whereCondition='email=\'%s\'';$parameters=$inputEmail;$result=
