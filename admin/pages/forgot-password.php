...
*****************************************************************************/
					...
					$errors['inputEmail']=Message('sendpassword_admin_alreadysent');else{$newPassword=generatePassword();$hashedPw=hashPassword($newPassword,$admin['passwort_salt']);$columns=array('passwort_neu'=>$hashedPw,
