...
if ($action == "delete") {
	...
	$db->queryDelete(Config("db_prefix") . "_matchreport", "id = %d", array($itemId));
...
echo "<fieldset><legend>". Message("match_manage_createmessage_title") ."</legend>";
...
if (!count($reportItems))echo createInfoMessage("", Message("match_manage_reportitems_noitems"));
else {
