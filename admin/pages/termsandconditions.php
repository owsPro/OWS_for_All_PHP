...
$termsFile = BASE_FOLDER.'/admin/config/termsandconditions.xml';if(!file_exists($termsFile))throw new Exception('File does not exist: '.$termsFile);$xml=simplexml_load_file($termsFile);$termsConfig=escapeOutput($xml->xpath("//pagecontent[@lang='".$selectedLang."'][1]"));
