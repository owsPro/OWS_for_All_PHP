...
*****************************************************************************/
					...
					$i18n->setCurrentLanguage($_GET['lang']);$root=$_SERVER['DOCUMENT_ROOT'];$inc=$root.'/cache/adminmessages_%s.inc.php';include(escapeOutput(sprintf($inc,$i18n->getCurrentLanguage())));$root=$_SERVER['DOCUMENT_ROOT'];$inc=$root.
					'/languages/messages_%s.php';include(escapeOutput(sprintf($inc,$i18n->getCurrentLanguage())));$errors=[];$inputUser=(isset($_POST['inputUser']))?$_POST['inputUser']:FALSE;$inputPassword=(isset($_POST['inputPassword']))?$_POST['inputPassword']:FALSE;
