...
*****************************************************************************/
								...
								$hashedPw=hashPassword($newPassword,$admin['passwort_salt']);$columns=array('passwort_neu'=>$hashedPw,'passwort_neu_angefordert'=>$now);$fromTable=$conf['db_prefix'].'_admin';$whereCondition='id=%d';$parameter=$admin['id'];
