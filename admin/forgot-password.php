...
*****************************************************************************/
	...
	'/cache/wsconfigadmin.inc.php',$i18n->getCurrentLanguage())));include(sprintf(escapeOutput($_SERVER['DOCUMENT_ROOT']).'/languages/messages_%s.php',$i18n->getCurrentLanguage()));$errors=[];$inputEmail=(isset($_POST['inputEmail']))?trim($_POST['inputEmail']):FALSE;
